...
gripperNode::gripperNode(rclcpp::Node::SharedPtr node_ptr) : node_(node_ptr),
															 gripper_object_()
{
	node_->create_service<std_srvs::srv::SetBool>("on", std::bind(&gripperNode::gripperOnCallback,this,std::placeholders::_1,std::placeholders::_2));
	node_->create_service<std_srvs::srv::SetBool>("off", std::bind(&gripperNode::gripperOffCallback,this,std::placeholders::_1,std::placeholders::_2));
